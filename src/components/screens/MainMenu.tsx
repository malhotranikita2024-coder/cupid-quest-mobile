...
export function MainMenu({
  ...
  return (
    ...
    >
      ...
      {/* TITLE - SUPER LOVE QUEST — only scale down on mobile */}
      <div className="absolute top-[12%] left-1/2 -translate-x-1/2 z-20 text-center">
        <div className="flex items-start justify-center gap-1">
          <span 
            className="font-display text-5xl max-[1023px]:text-2xl font-black"
            style={{
          ...
          <span className="text-3xl max-[1023px]:text-xl mt-1">💕</span>
        </div>
        <div className="flex items-center justify-center -mt-2">
          <span 
            className="font-display text-6xl max-[1023px]:text-3xl font-black"
            style={{
          ...
          <span 
            className="font-display text-6xl max-[1023px]:text-3xl font-black ml-2"
            style={{
      ...
      <div className="absolute bottom-[22%] max-[1023px]:bottom-[16%] left-1/2 -translate-x-1/2 z-30" style={{ maxHeight: '50vh', overflowY: 'auto' }}>
        <div 
